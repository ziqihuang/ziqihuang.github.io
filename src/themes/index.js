...
export const THEMES = {
  ...
  china: {
    ...
    label: "中国 / China",
    flag: "CN",
    styleName: "水墨 Shui Mo",
    description: "宣纸与流动墨韵。雾染山峦、笔意节奏、留白静气。",
    cursor: "soft",
    loader: "fade",
    tokens: {
      "--bg": "#ece4d6",
      "--bg-2": "#ddd2c0",
      "--surface": "rgba(236, 228, 214, 0.94)",
      "--surface-line": "rgba(20, 20, 20, 0.18)",
      "--primary": "#141414",
      "--accent": "#3d4a56",
      "--accent-2": "#7a6b58",
      "--text": "#121010",
      "--text-dim": "#5c554c",
      "--glow": "0 2px 20px rgba(20, 20, 20, 0.12)",
      "--glow-accent": "0 4px 28px rgba(61, 74, 86, 0.16)",
      "--font-display": "'Noto Serif SC', 'Songti SC', serif",
      "--font-mono": "'Noto Serif SC', 'Songti SC', serif",
      "--radius": "2px",
      "--motif": "shuimo",
    },
  },
